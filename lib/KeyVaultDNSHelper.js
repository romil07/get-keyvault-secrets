...
exports.KeyVaultDNSHelper = void 0;
const core = __importStar(require("@actions/core"));
const exec = __importStar(require("@actions/exec"));
const io = __importStar(require("@actions/io"));
class KeyVaultDNSHelper {
    static getBaseUrl() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._vaultDnsSuffix) {
                let azCloudDetails = JSON.parse(yield KeyVaultDNSHelper.executeAzCliCommand('cloud show'));
    ...
    static getVaultDNSSuffix(cloudEndpoints) {
...
exports.KeyVaultDNSHelper = KeyVaultDNSHelper;
